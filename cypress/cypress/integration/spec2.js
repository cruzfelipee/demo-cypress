describe('Teste End-to-End', () => {
    it('Teste 1: Visita Página', () => {
        // abre o site
        cy.visit('http://localhost:5000/') //por algum motivo ele fica com mensagem de "sorry we could not load" pro cypress, embora funcione pra mim 
    })
    ...
    it('Teste 4: Compra do livro', () => { //como nao consegui testar, so botei oq eu acho que deveria ser
